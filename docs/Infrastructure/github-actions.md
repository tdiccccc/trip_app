...
| 情報 | 例 | 用途 |
|------|-----|------|
| GCP プロジェクト ID | `trip-app-app` | GitHub Secret `GCP_PROJECT_ID` |
| GCP プロジェクト番号 | `123456789012` | Workload Identity Pool の設定 |
| サービスアカウントメール | `github-actions@trip-app-app.iam.gserviceaccount.com` | GitHub Secret `GCP_SERVICE_ACCOUNT` |
| Workload Identity Provider ID | `projects/.../providers/github` | GitHub Secret `GCP_WORKLOAD_IDENTITY_PROVIDER` |
| GitHub リポジトリ (owner/repo) | `your-username/trip-app-app` | WIF の属性条件 |
...
GITHUB_REPO="your-username/trip-app-app"
...
> `your-username/trip-app-app` を実際のリポジトリ名に置き換えること。
